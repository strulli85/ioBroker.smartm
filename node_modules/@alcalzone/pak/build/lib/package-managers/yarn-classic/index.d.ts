import { CommandResult, InstallOptions, PackageManager, PackOptions, UninstallOptions, UpdateOptions } from "../package-manager";
export declare class YarnClassic extends PackageManager {
    ...
    pack(_options?: PackOptions): Promise<CommandResult>;
}
