...
class Npm extends package_manager_1.PackageManager {
    ...
    async pack({ targetDir = this.cwd, workspace = ".", } = {}) {
        ...
        if ((0, semver_1.gte)(npmVersion, "7.0.0")) {
            ...
            try {
                ...
                return Object.assign(Object.assign({}, result), { stdout: targetPath });
            }
            finally {
                this.cwd = prevCwd;
            }
