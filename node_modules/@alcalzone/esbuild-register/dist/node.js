...
var require_node_modules_regexp = __commonJS({
  "node_modules/node-modules-regexp/index.js"(exports, module2) {
    "use strict";
...
joycon.addLoader({
  ...
  loadSync: (file) => {
    ...
    return _jsoncparser.parse.call(void 0, content);
  }
});
var getOptions = (cwd) => {
  var _a, _b, _c;
...
function register(esbuildOptions = {}) {
  const _a = esbuildOptions, {extensions = DEFAULT_EXTENSIONS} = _a, overrides = __objRest(_a, ["extensions"]);
  const compile = function compile2(code, filename, format) {
    ...
    const {code: js, warnings, map: jsSourceMap} = _esbuild.transformSync.call(void 0, code, __spreadValues({
      sourcefile: filename,
      sourcemap: "both",
  ...
  (0, import_pirates.addHook)(compile, {
    exts: extensions,
